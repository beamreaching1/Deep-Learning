# -*- coding: utf-8 -*-
"""
Created on Mon Apr 12 16:30:24 2021
...
for epoch in range(num_epochs):
    ...
    for i, data in enumerate(dataloader, 0):
        ...
        if i % 50 == 0:
            ...
            if i != 0:
                vutils.save_image(img_list[-1],"./"+"last"+".jpeg")
...
# Model state storage
savePath = os.path.join("./save/", "DCGAN.pickle")
...
for index, i in enumerate(fakeSet):
    vutils.save_image(i,"./fake/"+str(index)+".jpeg")

for index, i in enumerate(realSet):
    vutils.save_image(i,"./real/"+str(index)+".jpeg")
